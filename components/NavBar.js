...
import logo from "../public/images/logogc.png";
...
function NavBar() {
  ...
  const handleLogout = () => {
    ...
    dispatch({
      type: "NOTIFY",
      payload: { success: "¡Cerraste tu sesión correctamente!" },
    });
    return router.push("/");
  };
  ...
  return (
    <header>
        ...
        <div className="collapse navbar-collapse justify-content-end">
          <ul className="navbar-nav social-collapse p-1">
            ...
            <li className="icono-redes">
              <a
                href="https://www.facebook.com/granja.elcedro/"
                target="_blank"
              >
                <img src="images/iconos-redes1.png" alt="iconos-redes" />
              </a>
            </li>
            <li className="icono-redes">
            ...
            <li className="icono-redes">
              <a
                href="https://www.instagram.com/granja.elcedro/?hl=es"
                target="_blank"
              >
                <img src="images/iconos-redes3.png" alt="iconos-redes" />
              </a>
            </li>
          </ul>
        </div>
        ...
        <ul className="">
          ...
          <li className="nav-item">
            <Link href="/sucursales">
              <a
                style={{ color: "white" }}
                className={"nav-link" + isActive("/sucursales")}
              >
                SUCURSALES
              </a>
            </Link>
      ...
      <nav
        className="links-list-vertical collapse navbar-collapse justify-content-end"
